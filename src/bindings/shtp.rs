...
pub const DR_OF_CONFIG: u32 = 57040;
pub const DR_WHEEL_CONFIG: u32 = 57041;
...
pub const DR_FUSION_CONFIG: u32 = 57047;
...
pub const sh2_SensorId_e_SH2_MAX_SENSOR_ID: sh2_SensorId_e = 45;
...
pub struct sh2_SensorConfig {
    ...
    #[doc = "be sent to host, but reportInterval_us and"]
    #[doc = "sensorSpecific do not influence sensor"]
    #[doc = "operation. Not supported by all sensors."]
...
fn bindgen_test_layout_sh2_SensorConfig() {
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<sh2_SensorConfig>())).sniffEnabled as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(sh2_SensorConfig),
...
extern "C" {
    ...
    #[doc = " @parameter wheelIndex platform-dependent: 0= left, 1= right for"]
    #[doc = "   typical differential drive robot"]
    #[doc = " @parameter timestamp microsecond timestamp (hub scale) of measurement"]
    #[doc = " @parameter wheelData raw wheel position or velocity"]
    #[doc = " @parameter dataType 0 if data is position, 1 if data is velocity"]
    #[doc = " @return SH2_OK (0), on success.  Negative value from sh2_err.h on error."]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = " @return SH2_OK (0), on success.  Negative value from sh2_err.h on error."]
    pub fn sh2_saveDeadReckoningCalNow() -> cty::c_int;
}
...
fn bindgen_test_layout_sh2_RawOptFlow() {
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<sh2_RawOptFlow>())).timestamp as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<sh2_RawOptFlow>())).dt as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(sh2_RawOptFlow),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<sh2_RawOptFlow>())).dx as *const _ as usize },
        6usize,
        concat!(
            "Offset of field: ",
            stringify!(sh2_RawOptFlow),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<sh2_RawOptFlow>())).dy as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(sh2_RawOptFlow),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<sh2_RawOptFlow>())).iq as *const _ as usize },
        10usize,
        concat!(
            "Offset of field: ",
            stringify!(sh2_RawOptFlow),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<sh2_RawOptFlow>())).resX as *const _ as usize },
        12usize,
        concat!(
            "Offset of field: ",
            stringify!(sh2_RawOptFlow),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<sh2_RawOptFlow>())).resY as *const _ as usize },
        13usize,
        concat!(
            "Offset of field: ",
            stringify!(sh2_RawOptFlow),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<sh2_RawOptFlow>())).shutter as *const _ as usize },
        14usize,
        concat!(
            "Offset of field: ",
            stringify!(sh2_RawOptFlow),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<sh2_RawOptFlow>())).frameMax as *const _ as usize },
        15usize,
        concat!(
            "Offset of field: ",
            stringify!(sh2_RawOptFlow),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<sh2_RawOptFlow>())).frameAvg as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(sh2_RawOptFlow),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<sh2_RawOptFlow>())).frameMin as *const _ as usize },
        17usize,
        concat!(
            "Offset of field: ",
            stringify!(sh2_RawOptFlow),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<sh2_RawOptFlow>())).laserOn as *const _ as usize },
        18usize,
        concat!(
            "Offset of field: ",
            stringify!(sh2_RawOptFlow),
...
fn bindgen_test_layout_sh2_DeadReckoningPose() {
    ...
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<sh2_DeadReckoningPose>())).timestamp as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<sh2_DeadReckoningPose>())).linPosX as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(sh2_DeadReckoningPose),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<sh2_DeadReckoningPose>())).linPosY as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(sh2_DeadReckoningPose),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<sh2_DeadReckoningPose>())).linPosZ as *const _ as usize },
        12usize,
        concat!(
            "Offset of field: ",
            stringify!(sh2_DeadReckoningPose),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<sh2_DeadReckoningPose>())).i as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(sh2_DeadReckoningPose),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<sh2_DeadReckoningPose>())).j as *const _ as usize },
        20usize,
        concat!(
            "Offset of field: ",
            stringify!(sh2_DeadReckoningPose),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<sh2_DeadReckoningPose>())).k as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(sh2_DeadReckoningPose),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<sh2_DeadReckoningPose>())).real as *const _ as usize },
        28usize,
        concat!(
            "Offset of field: ",
            stringify!(sh2_DeadReckoningPose),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<sh2_DeadReckoningPose>())).linVelX as *const _ as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(sh2_DeadReckoningPose),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<sh2_DeadReckoningPose>())).linVelY as *const _ as usize },
        36usize,
        concat!(
            "Offset of field: ",
            stringify!(sh2_DeadReckoningPose),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<sh2_DeadReckoningPose>())).linVelZ as *const _ as usize },
        40usize,
        concat!(
            "Offset of field: ",
            stringify!(sh2_DeadReckoningPose),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<sh2_DeadReckoningPose>())).angVelX as *const _ as usize },
        44usize,
        concat!(
            "Offset of field: ",
            stringify!(sh2_DeadReckoningPose),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<sh2_DeadReckoningPose>())).angVelY as *const _ as usize },
        48usize,
        concat!(
            "Offset of field: ",
            stringify!(sh2_DeadReckoningPose),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<sh2_DeadReckoningPose>())).angVelZ as *const _ as usize },
        52usize,
        concat!(
            "Offset of field: ",
            stringify!(sh2_DeadReckoningPose),
...
fn bindgen_test_layout_sh2_SensorValue__bindgen_ty_1() {
    ...
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<sh2_SensorValue__bindgen_ty_1>())).rawOptFlow as *const _
                as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<sh2_SensorValue__bindgen_ty_1>())).deadReckoningPose as *const _
                as usize
        },
        0usize,
        concat!(
